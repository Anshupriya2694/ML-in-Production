...
if __name__ == '__main__':
    ...
    # Model parameters
    parser.add_argument('--input_dim', type=int, default=2, metavar='INPUT',
                       help='number of features (default: 2)')
    parser.add_argument('--hidden_dim', type=int, default=10, metavar='HIDDEN',
                       help='number of hidden layers (default: 10)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUTPUT',
